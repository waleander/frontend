...
//   TODO: not a toplevelsection, potentially needs to be a slightly different object, with a shared getEdition function?
  case object NavFooterLinks extends TopLevelSection {
    val name = "life"
